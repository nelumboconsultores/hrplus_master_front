...
export const FiltersForm: React.FC<FiltersFormProps> = ({ initVal, setInitVal, getDataTable }) => {
  ...
  const onSubmit: SubmitHandler<DynamicFormValues> = async (data) => {
    setInitVal(data)
    const geographyStructIds: number[] | string = []
    ...
    await getDataTable(
      ...
      finalData.geographyStructIds as string,
    )
  }
